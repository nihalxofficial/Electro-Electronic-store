...
export default function CustomerTransactionsClient() {
  const [transactions, setTransactions] = useState<CustomerTransaction[]>(MOCK_TRANSACTIONS_LIST);
  const [savedCards, setSavedCards] = useState<SavedPaymentCard[]>(INITIAL_SAVED_CARDS);
